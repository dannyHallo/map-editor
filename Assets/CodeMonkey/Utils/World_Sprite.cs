...
namespace CodeMonkey.Utils
{
    ...
    public class World_Sprite
    {
        ...
        public static World_Sprite CreateDebugButton(Transform parent, Vector3 localPosition, string text, System.Action ClickFunc, int fontSize = 30, float paddingX = 5, float paddingY = 5)
        {
            ...
            TextMeshPro textMeshPro = UtilsClass.CreateWorldText(text, gameObject.transform, Vector3.zero, fontSize, Color.white, TextAnchor.MiddleCenter, TextAlignment.Center, 20000);
            Bounds rendererBounds = textMeshPro.GetComponent<MeshRenderer>().bounds;
