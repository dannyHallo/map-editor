...
namespace CodeMonkey.Utils
{
    ...
    public static class UtilsClass
    {
        ...
        {
            TextMeshPro textMeshPro = CreateWorldText(GetTextFunc(), parent, localPosition, fontSize, color, textAnchor, textAlignment, sortingOrder);
        ...
        {
            TextMeshPro textMeshPro = CreateWorldText(parent, text, localPosition, fontSize, color, TextAnchor.LowerLeft, TextAlignment.Left, sortingOrderDefault);
